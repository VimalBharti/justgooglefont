<template>
    <div class="h-full overflow-hidden relative flex">
      ...
      <section class="w-full h-full overflow-y-auto">
        ...
        <template v-else>
          <div class="min-h-screen h-full bg-neutral-900" :style="{ fontFamily: selectedFont }">
            ...
            <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7">
              <nav class="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-6 mx-auto" aria-label="Global">
                <div class="md:col-span-3">
                  <!-- Logo -->
                  <a class="flex-none rounded-xl text-xl font-semibold focus:outline-none focus:opacity-80 flex items-center" href="/">
                    <img src="/images/logo-white.png" alt="just-google-font" class="w-12 ">
                    <span>JustGoogleFont</span>
                  </a>
                  <!-- End Logo -->
                </div>
                  ...
                  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    <div class="max-w-2xl text-center mx-auto">
                      <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl dark:text-white">
                        ...
                        <span class="text-lime-400">Michelangelo</span>
                      </h1>
                      <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Art is never finished, only abandoned</p>
                    </div>

                    <div class="mt-10 relative max-w-5xl mx-auto">
                      <div class="w-full object-cover h-96 sm:h-[480px] bg-[url('/images/hero.jpeg')] bg-no-repeat bg-center bg-cover rounded-xl"></div>
                ...
                <div class=" grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                  ...
                  <a class="group block" href="#">
                    <div class="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                      <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl" src="/images/birmingham-museums-trust-Cv0k6jv3-Vo-unsplash.jpeg" alt="Image Description">
                    </div>
                  ...
                  <a class="group block" href="#">
                    <div class="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                      <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl" src="/images/birmingham-museums-trust-flaxAD9Hw4Y-unsplash.jpeg" alt="Image Description">
                    </div>
                  ...
                  <a class="group block" href="#">
                    <div class="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                      <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl" src="/images/birmingham-museums-trust-G1Z0cIMYHVM-unsplash.jpeg" alt="Image Description">
                    </div>
                  ...
                  <a class="group block" href="#">
                    <div class="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                      <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl" src="/images/europeana--kUYkiWWM6E-unsplash.jpeg" alt="Image Description">
                    </div>
                ...
                <div class="max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
                  <blockquote class="max-w-4xl mx-auto">
                    <p class="mb-6 md:text-lg">
                      <span class="font-semibold text-lime-400">Jean-Baptiste Camille Corot,</span> <span class="text-neutral-500">Painter</span>
                    </p>
              ...
              <div class="max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
                  <div class="aspect-w-16 aspect-h-6 lg:aspect-h-14 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl" src="/images/europeana-OPE3qT-l2gc-unsplash.jpeg" alt="Image Description">
                  </div>
                  <!-- End Col -->
